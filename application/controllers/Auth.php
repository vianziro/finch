...
/*        if (!$this->ion_auth->logged_in() || !$this->ion_auth->is_admin())
        ...
        {
            $this->form_validation->set_rules('identity','','required|is_unique['.$tables['users'].'.'.$identity_column.']');
            $this->form_validation->set_rules('email', '', 'required|valid_email');
        }
        else
        {
            $this->form_validation->set_rules('email', '', 'required|valid_email|is_unique[' . $tables['users'] . '.email]');
        }
