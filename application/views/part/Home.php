...
<div class="ui small basic to-del test modal">
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            title: 'Ruby Mengomentari Pertanyaan Anda!',
            // (string | mandatory) the text inside the notification
            text: 'Ruby Mengomentari Pertanyaan Anda, "Ayam Goreng Enak Rasanya",  <a href="">Klik Disini</a>.',
            // (string | optional) the image to display on the left
            image: 'http://localhost/by/uploads/images/ruby.jpg',
